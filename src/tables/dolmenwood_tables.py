...
class DolmenwoodTables:
    ...
    def _register_character_tables(self) -> None:
        ...
        # Physical appearance
        self.manager.register_table(DolmenwoodTable(
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                ...
                TableEntry(roll_min=7, roll_max=7, result="Distinctive voice (deep, squeaky, etc.)"),
    ...
    def _register_encounter_tables(self) -> None:
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                TableEntry(roll_min=1, roll_max=1, result="Wild boar (1d4)", monster_refs=["wild_boar"], quantity="1d4"),
                TableEntry(roll_min=2, roll_max=2, result="Giant spider (1d3)", monster_refs=["giant_spider"], quantity="1d3"),
                TableEntry(roll_min=3, roll_max=3, result="Wolves (2d4)", monster_refs=["wolf"], quantity="2d4"),
                TableEntry(roll_min=4, roll_max=4, result="Bandits (2d6)", monster_refs=["bandit"], quantity="2d6"),
                TableEntry(roll_min=5, roll_max=5, result="Woodwose (1d6)", monster_refs=["woodwose"], quantity="1d6"),
                TableEntry(roll_min=6, roll_max=6, result="Moss dwarf patrol (1d4+1)", monster_refs=["moss_dwarf"], quantity="1d4+1"),
                TableEntry(roll_min=7, roll_max=7, result="Grimalkin (1)", monster_refs=["grimalkin"], quantity="1"),
                TableEntry(roll_min=8, roll_max=8, result="Deer or elk (peaceful)", monster_refs=["deer"]),
                ...
                TableEntry(roll_min=12, roll_max=12, result="Special encounter (roll on hex table)"),
            ]
        ))
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                TableEntry(roll_min=1, roll_max=1, result="Giant frog (1d4)", monster_refs=["giant_frog"], quantity="1d4"),
                TableEntry(roll_min=2, roll_max=2, result="Giant leech (1d3)", monster_refs=["giant_leech"], quantity="1d3"),
                TableEntry(roll_min=3, roll_max=3, result="Bog body (1d2)", monster_refs=["bog_body"], quantity="1d2"),
                TableEntry(roll_min=4, roll_max=4, result="Will-o'-wisp (1)", monster_refs=["will_o_wisp"]),
                TableEntry(roll_min=5, roll_max=5, result="Banshee (1)", monster_refs=["banshee"]),
                TableEntry(roll_min=6, roll_max=6, result="Giant snake (1d2)", monster_refs=["giant_snake"], quantity="1d2"),
                TableEntry(roll_min=7, roll_max=7, result="Drune scouts (1d4)", monster_refs=["drune"]),
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                TableEntry(roll_min=1, roll_max=1, result="Bandits (2d6)", monster_refs=["bandit"], quantity="2d6"),
                ...
                TableEntry(roll_min=8, roll_max=8, result="Wandering monster (roll terrain table)"),
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                TableEntry(roll_min=1, roll_max=1, result="40 feet", mechanical_effect="distance_40"),
                TableEntry(roll_min=2, roll_max=2, result="60 feet", mechanical_effect="distance_60"),
                TableEntry(roll_min=3, roll_max=3, result="80 feet", mechanical_effect="distance_80"),
                TableEntry(roll_min=4, roll_max=4, result="100 feet", mechanical_effect="distance_100"),
                TableEntry(roll_min=5, roll_max=5, result="120 feet", mechanical_effect="distance_120"),
                TableEntry(roll_min=6, roll_max=6, result="160 feet", mechanical_effect="distance_160"),
            ]
        ))
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                ...
                TableEntry(roll_min=5, roll_max=5, result="Fighting/arguing with another group"),
    ...
    def _register_treasure_tables(self) -> None:
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                TableEntry(roll_min=1, roll_max=2, result="Copper coins (2d100)", quantity="2d100"),
                TableEntry(roll_min=3, roll_max=4, result="Silver coins (1d100)", quantity="1d100"),
                TableEntry(roll_min=5, roll_max=6, result="Gold coins (3d20)", quantity="3d20"),
                TableEntry(roll_min=7, roll_max=7, result="Gems (1d4)", quantity="1d4", sub_table="gem_value"),
                TableEntry(roll_min=8, roll_max=8, result="Magic item", sub_table="magic_item_minor"),
            ]
        ))
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                TableEntry(roll_min=1, roll_max=1, result="10gp - Ornamental (agate, turquoise)"),
                TableEntry(roll_min=2, roll_max=2, result="50gp - Semiprecious (amethyst, jade)"),
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                ...
                TableEntry(roll_min=8, roll_max=8, result="Wand of Magic Detection (1d10 charges)", quantity="1d10"),
                ...
                TableEntry(roll_min=12, roll_max=12, result="Roll on major magic item table", sub_table="magic_item_major"),
            ]
        ))
    ...
    def _register_flavor_tables(self) -> None:
        ...
        self.manager.register_table(DolmenwoodTable(
            ...
            entries=[
                ...
                TableEntry(roll_min=10, roll_max=10, result="Everything seems too perfect, too peaceful"),
            ]
        ))
