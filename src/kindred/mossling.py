...
MOSSLING_SKILLS_ABILITY = KindredAbility(
    ...
    description=("Mosslings have a Skill Target of 5 for Survival when foraging."),
    is_passive=True,
    extra_data={
        "skill_bonuses": {
...
MOSSLING_TRINKET_TABLE = AspectTable(
    ...
    entries=[
        ...
        AspectTableEntry(
            ...
            item_id="mouse_organ_clock_blueprints",
        ),
        AspectTableEntry(
            99,
            100,
...
MOSSLING_DEFINITION = KindredDefinition(
    ...
    trinket_item_ids=[
        "bag_of_stone_marbles",
        "hallucinogenic_cheese_block",
        "bloodstained_redcap_hat",
        "saints_crime_book",
        "yeast_froth_shampoo",
        "honeysuckle_bouquet",
        "brass_cowbell",
        "moss_covered_hat",
        "bronze_mushroom_idol",
        "volcanic_rock_chunk",
        "clay_giant_figurine",
        "symbiotic_fungus_cluster",
        "gravestone_rock_collection",
        "mushroom_cooking_pot",
        "pressed_flower_journal",
        "boar_tusk_hunting_horn",
        "blue_cheese_massage_oil",
        "green_jelly_jar",
        "woodgrue_egg",
        "creature_gooseberry",
        "crawling_pink_sausage",
        "seasonal_leaf",
        "bug_spawning_mossy_rock",
        "swine_hunt_tapestry",
        "burping_puffball",
        "puffball_jelly_pouch",
        "half_empty_ale_bottles",
        "ancestor_spirits_bottle",
        "fear_inducing_shepherds_crook",
        "elven_lady_hair",
        "stolen_beetle",
        "breggle_effigy",
        "magic_wisdom_nuts",
        "return_snake",
        "tiny_toadstool_house",
        "regenerating_snail_shell",
        "squirrel_collar_and_leash",
        "moon_rat_people_story_book",
        "combustible_pipeweed",
        "trickling_watering_can",
        "upward_dripping_waterskin",
        "perpetual_cheese_wheel",
        "aging_wooden_carving",
        "fungi_incubator_peg_leg",
        "prophecy_worm",
        "whispering_mushroom",
        "dolmenwood_inn_map",
        "baby_shaped_onion",
        "mouse_organ_clock_blueprints",
        "bark_book",
    ],
    kindred_relations=(
