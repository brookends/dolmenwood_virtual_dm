...
BREGGLE_TRINKET_TABLE = AspectTable(
    ...
    entries=[
        AspectTableEntry(
            ...
            item_id="bag_of_divination_stones",
        ),
        AspectTableEntry(3, 4, "A bloodstained jester's hat", item_id="bloodstained_jesters_hat"),
        AspectTableEntry(
            5, 6, "A bloody knife that cannot be cleaned", item_id="bloody_knife_uncleaned"
        ),
        AspectTableEntry(
            7,
            8,
            "A blue velvet jacket with a hidden pocket which moves when you're not looking",
            item_id="blue_velvet_jacket_hidden_pocket",
        ),
        AspectTableEntry(
            9,
            10,
            "A book of poetry that consists primarily of bleating",
            item_id="book_of_bleating_poetry",
        ),
        AspectTableEntry(
            11,
            12,
            "A bottle of noxious perfume that can be smelt up to half a mile away",
            item_id="bottle_of_noxious_perfume",
        ),
        AspectTableEntry(
            13,
            14,
            "A brass owl statue with eerie black eyes",
            item_id="brass_owl_statue_black_eyes",
        ),
        AspectTableEntry(
            15,
            16,
            "A broken fishing rod that still displays teeth marks from an enormous fish",
            item_id="broken_fishing_rod_teeth_marks",
        ),
        AspectTableEntry(
            17,
            18,
            "A circular ceramic amulet which displays the current moon phase",
            item_id="circular_ceramic_moon_amulet",
        ),
        AspectTableEntry(
            19,
            20,
            "A clay pot labelled 'Frog Paste,' containing what appears to be frog paste",
            item_id="clay_pot_frog_paste",
        ),
        AspectTableEntry(
            21,
            22,
            "A clump of writhing, black moss that you scraped off a looming monolith one lonely night",
            item_id="clump_writhing_black_moss",
        ),
        AspectTableEntry(
            23,
            24,
            "A collection of papers with scrawled notes detailing your life story, found on a stranger drowned in a ditch",
            item_id="collection_life_story_papers",
        ),
        AspectTableEntry(
            25,
            26,
            "A curious mossling wind instrument carved out of a gourd",
            item_id="mossling_wind_instrument_gourd",
        ),
        AspectTableEntry(
            27,
            28,
            "A diorama of two stuffed mice riding stuffed squirrels, jousting",
            item_id="diorama_mice_squirrels_jousting",
        ),
        AspectTableEntry(
            29, 30, "A dried mushroom with a face", item_id="dried_mushroom_with_face"
        ),
        AspectTableEntry(
            31, 32, "A folio of pressed sprite-wings", item_id="folio_pressed_sprite_wings"
        ),
        AspectTableEntry(
            33, 34, "A gnarled root shaped like a mossling", item_id="gnarled_root_mossling_shaped"
        ),
        AspectTableEntry(
            35,
            36,
            "A letter warning that several high-ranked longhorns are secretly crookhorns in disguise",
            item_id="letter_warning_crookhorn_longhorns",
        ),
        AspectTableEntry(
            37,
            38,
            "A locket with a portrait of a fluffy cat wearing a crown inscribed 'For the love of King Pusskin'",
            item_id="locket_king_pusskin_portrait",
        ),
        AspectTableEntry(
            39, 40, "A long-nosed masquerade mask", item_id="long_nosed_masquerade_mask"
        ),
        AspectTableEntry(
            41,
            42,
            "A moleskin wristband, anointed with exotic fairy perfume",
            item_id="moleskin_wristband_fairy_perfume",
        ),
        AspectTableEntry(
            43,
            44,
            "A mossling pipe that blows rainbow-coloured smoke rings",
            item_id="mossling_pipe_rainbow_smoke",
        ),
        AspectTableEntry(
            45, 46, "A necklace of miscellaneous humanoid teeth", item_id="necklace_humanoid_teeth"
        ),
        AspectTableEntry(47, 48, "A petrified turnip", item_id="petrified_turnip"),
        AspectTableEntry(
            49, 50, "A pig heart that oozes ichor when squeezed", item_id="pig_heart_oozing_ichor"
        ),
        AspectTableEntry(
            51,
            52,
            "A pouch which feels heavy (as if full of pebbles) even when empty",
            item_id="pouch_feels_heavy_when_empty",
        ),
        AspectTableEntry(
            53,
            54,
            "A rusty scalpel that once belonged to Lord Malbleat",
            item_id="rusty_scalpel_lord_malbleat",
        ),
        AspectTableEntry(
            55, 56, "A sack of tasty fried chicken legs", item_id="sack_fried_chicken_legs"
        ),
        AspectTableEntry(
            57,
            58,
            "A scale said to be from a breggle with a fishtail instead of legs",
            item_id="scale_breggle_fishtail",
        ),
        AspectTableEntry(
            59,
            60,
            "A scroll containing a prophetic warning from an esteemed ancestor, almost indecipherable with age",
            item_id="scroll_prophetic_warning_ancestor",
        ),
        AspectTableEntry(
            61,
            62,
            "A sheet of parchment with a charcoal sketch of your long lost love",
            item_id="parchment_charcoal_sketch_love",
        ),
        AspectTableEntry(
            63,
            64,
            "A short length of silver cord and a delicate hook, said to catch fairy fish in puddles",
            item_id="silver_cord_delicate_hook",
        ),
        AspectTableEntry(
            65,
            66,
            "A shovel stained with the dirt of a thousand graves",
            item_id="shovel_thousand_graves_dirt",
        ),
        AspectTableEntry(
            67,
            68,
            "A stuffed vole dressed in a charming waistcoat",
            item_id="stuffed_vole_charming_waistcoat",
        ),
        ...
        AspectTableEntry(
            ...
            item_id="tin_whistle_drives_cats_wild",
        ),
        AspectTableEntry(
            73,
            74,
            "A tiny book of nonsense poetry, bound in purple leather",
            item_id="tiny_book_nonsense_poetry",
        ),
        AspectTableEntry(
            75,
            76,
            "A tiny painting of a four-horned goat",
            item_id="tiny_painting_four_horned_goat",
        ),
        AspectTableEntry(
            77,
            78,
            "A well-loved walking stick with a goat's head handle",
            item_id="walking_stick_goat_head_handle",
        ),
        AspectTableEntry(
            79,
            80,
            "A wooden Chapes (holy symbol of the Pluritine Church) studded with nails",
            item_id="wooden_chapes_studded_nails",
        ),
        AspectTableEntry(
            81,
            82,
            "An empty notebook where anything written disappears at sunrise",
            item_id="empty_notebook_disappearing_writing",
        ),
        AspectTableEntry(
            83,
            84,
            "An ornate pie pan, pilfered from a noble's kitchen",
            item_id="ornate_pie_pan_pilfered",
        ),
        AspectTableEntry(
            85,
            86,
            "Black stone dice with white skulls for pips",
            item_id="black_stone_dice_skull_pips",
        ),
        AspectTableEntry(
            87,
            88,
            "Expensive-looking (but worthless) jewellery, designed for breggle horns",
            item_id="worthless_breggle_horn_jewellery",
        ),
        AspectTableEntry(
            89,
            90,
            "String from the bow of a legendary hunter",
            item_id="string_legendary_hunter_bow",
        ),
        AspectTableEntry(
            91,
            92,
            "The board pieces for fairy chess, rules unknown",
            item_id="fairy_chess_board_pieces",
        ),
        ...
        AspectTableEntry(
            ...
            item_id="ancestor_horn_necklace",
        ),
        AspectTableEntry(
            97, 98, "The key to the prison cell you escaped from", item_id="prison_cell_key_escaped"
        ),
        AspectTableEntry(
            99,
            100,
            "Your grandmother's creepy glass eye, sometimes you feel her presence watching",
            item_id="grandmother_creepy_glass_eye",
        ),
    ],
)
...
BREGGLE_DEFINITION = KindredDefinition(
    ...
    trinket_item_ids=[
        "bag_of_divination_stones",
        "bloodstained_jesters_hat",
        "bloody_knife_uncleaned",
        "blue_velvet_jacket_hidden_pocket",
        "book_of_bleating_poetry",
        "bottle_of_noxious_perfume",
        "brass_owl_statue_black_eyes",
        "broken_fishing_rod_teeth_marks",
        "circular_ceramic_moon_amulet",
        "clay_pot_frog_paste",
        "clump_writhing_black_moss",
        "collection_life_story_papers",
        "mossling_wind_instrument_gourd",
        "diorama_mice_squirrels_jousting",
        "dried_mushroom_with_face",
        "folio_pressed_sprite_wings",
        "gnarled_root_mossling_shaped",
        "letter_warning_crookhorn_longhorns",
        "locket_king_pusskin_portrait",
        "long_nosed_masquerade_mask",
        "moleskin_wristband_fairy_perfume",
        "mossling_pipe_rainbow_smoke",
        "necklace_humanoid_teeth",
        "petrified_turnip",
        "pig_heart_oozing_ichor",
        "pouch_feels_heavy_when_empty",
        "rusty_scalpel_lord_malbleat",
        "sack_fried_chicken_legs",
        "scale_breggle_fishtail",
        "scroll_prophetic_warning_ancestor",
        "parchment_charcoal_sketch_love",
        "silver_cord_delicate_hook",
        "shovel_thousand_graves_dirt",
        "stuffed_vole_charming_waistcoat",
        "thigh_bone_flute",
        "tin_whistle_drives_cats_wild",
        "tiny_book_nonsense_poetry",
        "tiny_painting_four_horned_goat",
        "walking_stick_goat_head_handle",
        "wooden_chapes_studded_nails",
        "empty_notebook_disappearing_writing",
        "ornate_pie_pan_pilfered",
        "black_stone_dice_skull_pips",
        "worthless_breggle_horn_jewellery",
        "string_legendary_hunter_bow",
        "fairy_chess_board_pieces",
        "cured_deer_skin_whole",
        "ancestor_horn_necklace",
        "prison_cell_key_escaped",
        "grandmother_creepy_glass_eye",
    ],
    kindred_relations=(
